...
namespace PlatformGameCreator.Editor.Xna
{
    ...
    class GraphicsDeviceService : IGraphicsDeviceService
    {
        ...
        /// <param name="width">Width of the graphics device.</param>
        /// <param name="height">Height of the graphics device.</param>
        ...
        /// </summary>
        /// <param name="disposing">Indicates whether the last control should dispose the singleton instance.</param>
